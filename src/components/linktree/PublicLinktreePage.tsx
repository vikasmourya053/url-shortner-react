...
export function PublicLinktreePage({ username, initialData }: PublicLinktreePageProps) {
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            {/* Stats - Only show if user has links */}
            ...
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-4v4m-6-4h.01M12 16h.01M16 20h4M4 4h4m0 0v4m0-4v4m0 0h4m-4 0v4m0 0h4m-4 0v4m0 0h4m-4 0v4" />
              </svg>
              QR Code
            </button>
          </div>
